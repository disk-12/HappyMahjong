...
export const { addDora,removeDora,switchRiichi,switchIppatsu,switchChankan,switchRinshan,switchHoutei,switchHaitei,setLastIndex,reset} = optionSlice.actions;
